...
TEST(Matmul, GradientA) {
  ...
  quasai::core::Tensor input_a = quasai::core::Tensor::from_data(data_a.data(), shape_a, quasai::core::DType::FLOAT32);
  quasai::core::Tensor input_b = quasai::core::Tensor::from_data(data_b.data(), shape_b, quasai::core::DType::FLOAT32);
  ...
  quasai::core::Tensor input_a_plus = quasai::core::Tensor::from_data(data_a_plus.data(), shape_a, quasai::core::DType::FLOAT32);
  quasai::core::Tensor input_a_minus = quasai::core::Tensor::from_data(data_a_minus.data(), shape_a, quasai::core::DType::FLOAT32);
