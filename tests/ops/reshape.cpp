...
TEST(Reshape, Float32) {
  ...
  quasai::core::Tensor result = quasai::ops::reshape(tensor, quasai::core::Shape{3, 2});
...
TEST(Reshape, Float64) {
  ...
  quasai::core::Tensor result = quasai::ops::reshape(tensor, quasai::core::Shape{4});
...
TEST(Reshape, Int32) {
  ...
  quasai::core::Tensor result = quasai::ops::reshape(tensor, quasai::core::Shape{6});
...
TEST(Reshape, InvalidShape) {
  ...
  EXPECT_THROW(quasai::ops::reshape(tensor, quasai::core::Shape{2, 2}), std::runtime_error);
}
...
TEST(Reshape, Gradient) {
  ...
  quasai::core::Tensor output = quasai::ops::reshape(input, quasai::core::Shape{4});
  output.backward();
  ...
  quasai::core::Tensor input_plus = quasai::core::Tensor::from_data(data_plus.data(), shape, quasai::core::DType::FLOAT32);
  quasai::core::Tensor input_minus = quasai::core::Tensor::from_data(data_minus.data(), shape, quasai::core::DType::FLOAT32);

  quasai::core::Tensor out_plus = quasai::ops::reshape(input_plus, quasai::core::Shape{4});
  quasai::core::Tensor out_minus = quasai::ops::reshape(input_minus, quasai::core::Shape{4});
