...
Parameter zeros(const Shape &shape, DType dtype, Device device) {
  return Parameter(Tensor::zeros(shape, dtype, device));
}

Parameter ones(const Shape &shape, DType dtype, Device device) {
  return Parameter(Tensor::ones(shape, dtype, device));
}
...
Parameter he_uniform(const Shape &shape, DType dtype, Device device) {
...
Parameter he_normal(const Shape &shape, DType dtype, Device device) {
  if (shape.dimensions() < 2) {
...
Parameter glorot_uniform(const Shape &shape, DType dtype, Device device) {
  if (shape.dimensions() < 2) {
...
Parameter glorot_normal(const Shape &shape, DType dtype, Device device) {
  if (shape.dimensions() < 2) {
